        ...
        <div className="relative mt-20 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {service.process.map((step, index) => (
            <motion.div
              ...
              "
            >
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-accent-purple to-accent-blue text-2xl font-bold text-white">
                {index + 1}
              </div>
              ...
              <p className="mt-4 leading-7 text-accent-gray">
                Every phase is carefully planned and executed to ensure quality,
                compliance, timely delivery, and complete customer satisfaction.
              </p>
            </motion.div>
          ))}
        </div>

...
export function OurVision() {
  return (
<section className="relative px-4 py-12 sm:px-6 lg:px-10 lg:py-20">
  <div className="mx-auto grid max-w-container items-center gap-12 lg:grid-cols-2 lg:gap-16">
    ...
    >
      ...
      <p className="mt-4 max-w-lg text-lg text-accent-white/90">
        To be the global benchmark in enterprise security and system integration,
        we envision a future where every organization is resilient, secure, and
        technologically advanced — driven by our commitment to innovation and to
      ...
      <ul className="mt-8 flex max-w-lg flex-col gap-4">
        {VISION_POINTS.map((point) => (
          <li key={point.text} className="flex items-start gap-3">
            ...
            <span className="text-sm leading-6 text-accent-white/90">
              {point.text}
            </span>
          </li>
        ))}
